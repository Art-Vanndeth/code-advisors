...
keytool -genkeypair \
  -alias server \
  -dname "CN=chhaya, OU=Engineering, O=Company, L=City, ST=State, C=US" \
  -ext "SAN=DNS:kafka-1,DNS:kafka-2,DNS:kafka-3,DNS:schema-registry,DNS:kafka-ui,DNS:debezium-kafka-connect,DNS:localhost,DNS:kafka.istad.co,IP:202.178.125.77,IP:34.143.151.53" \
